...
public class BlackListServiceImpl implements BlackListService {
    ...
    public boolean recordViolation(String type, String key) {
        ...
        if (count != null && count == 1) {
            redisTemplate.expire(countKey, COUNT_WINDOW_SECONDS, TimeUnit.SECONDS);
        }
    ...
    public boolean isBlackListed(String type, String key) {
        ...
        Boolean isMember = redisTemplate.opsForSet().isMember(setKey, key);
    ...
    @Override
    public Set<Object> getBlackList(String type) {
        String setKey = BLACKLIST_KEY_PREFIX + type;
